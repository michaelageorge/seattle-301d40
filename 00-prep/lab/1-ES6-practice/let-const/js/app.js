...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: rando no longer works because it is assigned a value in a different code block then where it is called in the console log.
  console.log(viewed);
