...
console.log(joe);
// Upon changing the code to an arrow function, it broke the code. This is because arrow functions do not create their own execution content. I changed the code back to a normal function. 
...
// When joe.scope() is invoked, as an arrow function, a blank object is created. 
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked as an arrow function, a blank object is created. 
// 3. Explain why "this" is different when an arrow function is used.
// An arrow function does not create its own execution context. 'this' does not exist.
